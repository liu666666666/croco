%==============================================================
% VERTICAL DISSIPATION TERM OF SPECTRAL KE BUDGET
...
%
  if loadmode==1,
    eval(['!cp ',root,specname,'_KE_W_l',num2str(ilevel),'.mat spectrum_KE.mat'])
    load spectrum_KE.mat
  else
    [amp,count,ktmp,dk]=compute_spectral_flux_W(ctl,model,dx,kchoice,window,lims,lit);
    amp=amp./42;
    save spectrum_KE amp count ktmp dk
    eval(['!mv spectrum_KE.mat ',root,specname,'_KE_W_l',num2str(ilevel),'.mat'])
  end
%
