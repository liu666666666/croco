...
%
  if loadmode==1,
    eval(['!cp ',root,specname,'_KE_Dv_l',num2str(ilevel),'.mat spectrum_KE.mat'])
    ...
    eval(['!mv spectrum_KE.mat ',root,specname,'_KE_Dv_l',num2str(ilevel),'.mat'])
  end
%
